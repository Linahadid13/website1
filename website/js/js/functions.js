    ...
    INSPIRO.slider = {
        ...
        sliderScreenSizeControl: function (elem) {
            ...
            var headerHeight = $header.outerHeight(),
                ...
                screenRatio = elem.hasClass('slider-fullscreen') ? 1 : 1.28,
    ...
    INSPIRO.elements = {
        ...
        animations: function () {
            ...
            if ($animate.length > 0) {
                ...
                //Check if jQuery appear plugin is loaded
                if (typeof $.fn.appear === 'undefined') {
                    INSPIRO.elements.notification("Warning: jQuery appear plugin is missing in plugins.js file.", "warning")
                    return true;
                }
                ...
                $animate.each(function () {
                    ...
                    //Initializing jQuery appear plugin and passing options from data animations attributes
                    if (elem.options.direction == "forward") {
                        elem.appear(function () {
                            ...
                            accX: Number(elem.options.offsetX),
                            accY: Number(elem.options.offsetY),
                        }, 'easeInOutCubic');
            ...
            if ($gridLayout.length > 0) {
                ...
                $gridLayout.each(function () {
                    ...
                    elem.options = {
                        ...
                        stagger: elem.attr('data-stagger') || 10,
                    ...
                    console.log(elem.options.itemSelector);
        ...
        instagram: function () {
            ...
            if ($widget_instagram.length > 0) {
                ...
                $widget_instagram.each(function () {
                    ...
                    var elem = $(this),
                        instagramLimit = elem.attr('data-limit') || 9,
